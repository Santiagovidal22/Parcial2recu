...
#define MAXIMA_OPCION_FILTRACION 4
		...
		if(!utn_GetIntRango(&opcionFiltracion, "\nOpciones de filtrado:\n 1- Minorista\n 2- Mayorista\n 3- Exportador\n 3- Exportador \n 4- Precio \n Elija una opcion ", "El dato ingresado es invalido. Ingrese una opcion correcta: ", MINIMA_OPCION_FILTRACION, MAXIMA_OPCION_FILTRACION, MAXIMA_OPCION_FILTRACION_CIFRAS))
		{
			switch(opcionFiltracion)
			{
				...
				case 3:
					...
					break;
				case 4:
					pFuncFiltradora = Servicios_FiltrarPorPrecio;
					break;
...
int Controller_FiltrarPorPrecio(LinkedList* this)
{
	int retorno;
	LinkedList* listaFiltradaprecio;
	int opcionFiltracion;
	int (*pFuncFiltradora)(void* pElemento);

	retorno=1;
	listaFiltradaprecio = NULL;
	pFuncFiltradora = NULL;
	...
	if(this != NULL)
	{
		...
		if(!utn_GetIntRango(&opcionFiltracion, "\nOpciones de filtrado:\n 1- Minorista\n 2- Mayorista\n 3- Exportador\n 3- Exportador \n 4- Precio \n Elija una opcion ", "El dato ingresado es invalido. Ingrese una opcion correcta: ", MINIMA_OPCION_FILTRACION, MAXIMA_OPCION_FILTRACION, MAXIMA_OPCION_FILTRACION_CIFRAS))
		{
			...
			listaFiltradaprecio = ll_filter(this, pFuncFiltradora);

			retorno = Controller_SaveTxt(listaFiltradaprecio, NOMBRE_ARCHIVO_SERVICIOS_FILTRADO);
		}
	}
	return retorno;
}
